          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button
                ...
                className="bg-primary hover:bg-orange-600 cursor-pointer text-white px-6 py-2.5 rounded-lg text-sm font-medium transition-all duration-300 shadow-md hover:shadow-lg flex items-center gap-2"
              >
              ...
              <div className="px-4 pt-2 pb-6 space-y-1">
                ...
                <div className="pt-4 px-3">
                  <button
                    ...
                    className="w-full bg-primary hover:bg-orange-600 cursor-pointer text-white px-6 py-3 rounded-lg text-base font-medium transition-all duration-300 shadow-md flex items-center justify-center gap-2"
                  >
